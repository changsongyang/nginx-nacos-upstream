...
set(CMAKE_C_FLAGS "-W -Wpointer-arith  -Wreturn-type -Wno-deprecated-declarations")
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} -W -Werror=uninitialized")
...
if (NOT CMAKE_CROSSCOMPILING)
    include(${CMAKE_CURRENT_LIST_DIR}/minilua.cmake)
...
if (NOT CMAKE_CROSSCOMPILING)
    include(${CMAKE_CURRENT_LIST_DIR}/buildvm.cmake)
...
if ("${LJ_TARGET_ARCH}" STREQUAL "x64")
    message(STATUS "LuaJIT: Enabling SSE4.2")
    target_compile_options(libluajit PRIVATE
            -msse4.2)
endif ()
